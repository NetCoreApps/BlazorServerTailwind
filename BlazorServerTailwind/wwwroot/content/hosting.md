...
##  [/BlazorServerTailwind.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorServerTailwind.Client)
...
## [/BlazorServerTailwind](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/BlazorServerTailwind)

The .NET 6 `/BlazorServerTailwind` backend server is required for this App's dynamic functions including the Hello API on the home page
